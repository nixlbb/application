...
local configpath=uci:get("AdGuard","AdGuard","configpath") or "/etc/AdGuard.yaml"
local binpath=uci:get("AdGuard","AdGuard","binpath") or "/usr/bin/AdGuard/AdGuard"
httpport=uci:get("AdGuard","AdGuard","httpport") or "3000"
m = Map("AdGuard", "AdGuard ")
m.description = translate("Free and open source, powerful network-wide ads & trackers blocking DNS server.")
m:section(SimpleSection).template  = "AdGuard/AdGuard_status"

s = m:section(TypedSection, "AdGuard")
s.anonymous=true
s.addremove=false
---- enable
...
o.datatype="port"
o.optional = false
o.description = translate("<input type=\"button\" style=\"width:210px;border-color:Teal; text-align:center;font-weight:bold;color:Green;\" value=\"AdGuard Web:"..httpport.."\" onclick=\"window.open('http://'+window.location.hostname+':"..httpport.."/')\"/>")
---- update warning not safe
local binmtime=uci:get("AdGuard","AdGuard","binmtime") or "0"
local e=""
...
if not fs.access(binpath) then
	...
	local version=uci:get("AdGuard","AdGuard","version")
	...
	if testtime~=tonumber(binmtime) or version==nil then
		...
		uci:set("AdGuard","AdGuard","version",version)
		uci:set("AdGuard","AdGuard","binmtime",testtime)
		uci:commit("AdGuard")
	end
	e=version..e
end
...
o.template = "AdGuard/AdGuard_check"
...
---- Redirect
o = s:option(ListValue, "redirect", port..translate("Redirect"), translate("AdGuard redirect mode"))
o.placeholder = "none"
o:value("none", translate("none"))
o:value("dnsmasq-upstream", translate("Run as dnsmasq upstream server"))
o:value("redirect", translate("Redirect 53 port to AdGuard"))
o:value("exchange", translate("Use port 53 replace dnsmasq"))
o.default     = "none"
o.optional = true
---- bin path
o = s:option(Value, "binpath", translate("Bin Path"), translate("AdGuard Bin path if no bin will auto download"))
o.default     = "/usr/bin/AdGuard/AdGuard"
o.datatype    = "string"
o.optional = false
o.rmempty=false
...
o.rmempty = true
---- config path
o = s:option(Value, "configpath", translate("Config Path"), translate("AdGuard config path"))
o.default     = "/etc/AdGuard.yaml"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
---- work dir
o = s:option(Value, "workdir", translate("Work dir"), translate("AdGuard work dir include rules,audit log and database"))
o.default     = "/usr/bin/AdGuard"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
---- log file
o = s:option(Value, "logfile", translate("Runtime log file"), translate("AdGuard runtime Log file if 'syslog': write to system log;if empty no log"))
o.datatype    = "string"
o.rmempty = true
o.validate=function(self, value)
if fs.stat(value,"type")=="dir" then
...
o.write=function()
	luci.sys.exec("sh /usr/share/AdGuard/gfw2adg.sh del 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","AdGuard"))
end
o=s:option(Button,"gfwadd",translate("Add gfwlist"),translate(a))
o.optional = true
o.inputtitle=translate("Add")
o.write=function()
	luci.sys.exec("sh /usr/share/AdGuard/gfw2adg.sh 2>&1")
	luci.http.redirect(luci.dispatcher.build_url("admin","services","AdGuard"))
end
...
o.default     = ""
o.datatype    = "string"
o.template = "AdGuard/AdGuard_chpass"
o.optional = true
---- upgrade protect
...
local workdir=uci:get("AdGuard","AdGuard","workdir") or "/usr/bin/AdGuard"
...
o.cfgvalue = function(self, section)
	return fs.readfile("/usr/share/AdGuard/links.txt")
end
o.write = function(self, section, value)
	fs.writefile("/usr/share/AdGuard/links.txt", value:gsub("\r\n", "\n"))
end
fs.writefile("/var/run/lucilogpos","0")
function m.on_commit(map)
	if (fs.access("/var/run/AdGserverdis")) then
		io.popen("/etc/init.d/AdGuard reload &")
		return
	end
	local ucitracktest=uci:get("AdGuard","AdGuard","ucitracktest")
	...
	elseif ucitracktest=="0" then
		...
		if (fs.access("/var/run/AdGlucitest")) then
			uci:set("AdGuard","AdGuard","ucitracktest","0")
			io.popen("/etc/init.d/AdGuard reload &")
		else
			fs.writefile("/var/run/AdGlucitest","")
			if (ucitracktest=="2") then
				uci:set("AdGuard","AdGuard","ucitracktest","1")
			else
				uci:set("AdGuard","AdGuard","ucitracktest","2")
			end
		end
		uci:commit("AdGuard")
	end
